...
public class wyswietl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Base64</title>");
            out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"CSS/table.css\">");
            out.println("</head>");
            out.println("<body>");
            out.println(wyswietl()); 
            out.println("<div style=\"text-align: center; margin-top: 10px\"><a href=\"index.html\"><button style=\"font-size: 1.5rem\">Powrót na stronę główną</button></a></div>");
            out.println("</body>");
            out.println("</html>");
        }
    }
