 ...
 * @author student
 */
public class wstaw extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(act.equals("Wstaw")){
                wstaw(request.getParameter("autor"),request.getParameter("hash"));
    ...
    private void wstaw(java.lang.String autor, java.lang.String hash) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        webservice.SOAP port = service.getSOAPPort();
        port.wstaw(autor, hash);
    }
